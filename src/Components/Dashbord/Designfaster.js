  ...
  return (
    <div className="designfaster">
      ...
      <div className="cirle-earning ">
        <div className="circles aline-items percentage-circle">
          <div className="innercircle aline-items">
            <div className="innermostcircle aline-items">
              <RiCopperDiamondLine size="80" color="#" />
            </div>
          </div>
        </div>
        <p>Total earning</p>
      ...
      <div className="bg-blue" style={{ color: "white", fontWeight: "bold" }}>
        <div>
